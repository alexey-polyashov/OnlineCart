package ru.polyan.onlinecart.ws.config;
...
public class WebServiceConfig {
    ...
    // http://localhost:8080/onlinecart/ws/products.wsdl
    @Bean(name = "products")
    public DefaultWsdl11Definition groupsWsdl11Definition(XsdSchema groupsSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setPortTypeName("ProductsPort");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://www.polyan.ru/api/products");
